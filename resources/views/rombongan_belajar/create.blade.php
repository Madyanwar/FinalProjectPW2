        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Rombel</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('rombongan_belajars.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="dosen_pa" name="dosen_pa" required>
                        </div>
