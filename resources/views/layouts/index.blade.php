...
<head>
	...
	<link rel="stylesheet" type="text/css" href="asset_landingpage/style.css">
	...
	<header id="header">
        ...
        <div class="head-container">
			<div class="quote">
				...
				<h5>Di Sekolah Tinggi Teknologi Terpadu Nurul Fikri, kami menciptakan inovator masa depan yang berakar pada prinsip-prinsip moral dan teknologi modern. Dengan program akademik yang unggul dan lingkungan belajar yang inspiratif, kami mempersiapkan Anda untuk menjadi pemimpin di dunia digital yang terus berkembang</h5>
				<div class="play">
					<img src="images/icon/play.png" alt="play"><span><a href="" target="_blank">Watch Now</a></span>
				</div>
			</div>
			<div class="svg-image">
				<img src="images/extra/online-education.png" alt="svg">
			</div>
		</div>
		<div class="side-menu" id="side-menu">
			...
			<ul>
				...
				<li><a href="../#portfolio_section">Portfolio</a></li>
				<li><a href="../#services_section">Services</a></li>
				<li><a href="/profilTI">Profil</a></li>
